...
Visual, no-code data prep built directly into Databricks. Drag, drop, type in English, get a production-ready pipeline. No Alteryx license required.

**Public Preview** — runs on serverless compute. Admin may need to enable it in the preview portal.
